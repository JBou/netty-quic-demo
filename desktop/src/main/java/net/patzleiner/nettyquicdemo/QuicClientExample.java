...
public final class QuicClientExample {
    ...
    private static final InternalLogger LOGGER = InternalLoggerFactory.getInstance(QuicClientExample.class);
    ...
    public static void main(String[] args) throws Exception {
        ...
        try {
            ...
            QuicChannel quicChannel = QuicChannel.newBootstrap(channel)
                    ...
                    //.remoteAddress(new InetSocketAddress("192.168.1.12", 9999))
